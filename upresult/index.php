...
<html lang="en">
   <head>
      ...
      <title>Courses Management by FPT</title>
   ...
   <body>
      <header>
         <nav class="navbar navbar-expand-lg bg-white">
          <div class="container">
            <a class="navbar-brand" href="#"><img src="assets/images/logo.jpg" style="height: 70px"></a>
            ...
            <div class="item">
              <div class=" banner-view banner-top1 d-flex align-items-center justify-content-center text-center">
                <div class="banner-info-bg">
                  ...
                  <h5 style="color:black">Courses Management System</h5>
             ...
             <div class="item">
              <div class=" banner-view banner-top2 d-flex align-items-center justify-content-center text-center">
                <div class="banner-info-bg">
                  <h6>We are Creative</h6>
                  <h5>FPT company </h5>
                  <p class="mt-md-4 mt-3">Get the soft skills with FPT Course . </p>
                  <a class="btn btn-style btn-danger mt-sm-5 mt-4 mr-2" href=""> Learn More</a>
                </div>
              </div>
            </div>
      ...
      <section class="py-5 about"> 
        <div class="container">
          <div class="row ">
           <div class="col-md-6 ">
            <h3 class="title-big mx-0">Notifications</h3>
...
<?php }} ?>
            ...
            <div class="col-md-6">
              <img src="assets/images/anh111.jpeg" class="img-fluid">
            </div>
          </div>
        </div>
      </section>
            ...
            <div class="col-md-4">
                    <div class="grids5-info">
                        ...
                        <div class="blog-info">
                            ...
                            <h4><a href="#service">FPT Software Development</a></h4>
                        </div>
                    </div>
                </div>
        </div>
          ...
          <div class="container py-5">
            <div class="row footer-top-29">
              <div class="col-lg-4 col-md-6 col-sm-7 footer-list-29 footer-1 pr-lg-5">
                ...
                <p>Mayuri K. is working in PHP, PDO, Python and Laravel. Soon she is going to launch an online course on PHP projects for beginners. You can contact her for any Project development, either academic or commercial Projects.</p>
              ...
              <div class="col-lg-4 col-md-6 col-sm-7 footer-list-29 footer-4 mt-lg-0 mt-5">
                ...
                <p>Address : Mayuri Freelancer, 101 building Number, #2214 galaxy street, INDIA - 111111.</p>
                <p class="mt-2">Phone : <a href="tel:(+91) 9090909090">(+91)9090909090</a></p>
                <p class="mt-2">Email : <a href="mailto:info@result.com">info@result.com</a></p>
                <p class="mt-2">Support : <a href="mailto:info@result.com">info@result.com</a></p>
              </div>
            </div>
          </div>
        <!-- copyright -->
