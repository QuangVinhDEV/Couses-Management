                ...
                <div class="content-container">
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div" style="background-color: FF6600;">
                                <div class="col-sm-6">
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 text-center" >
                                        <a class="dashboard-stat" href="manage-students.php" style="background-color: orange;">
<?php 
...
<span class="bg-icon"><i class="fa fa-users"></i></span>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 text-center" >
                                        <a class="dashboard-stat" href="manage-subjects.php" style="background-color: skyblue;">
<?php 
...
?>
 <span class="bg-icon"><i class="fa fa-ticket"></i></span>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat" href="manage-classes.php" style="background-color: yellow;">
                                        <?php 
...
?><span class="bg-icon"><i class="fa fa-bank"></i></span>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 text-center">
                                        <a class="dashboard-stat" href="manage-results.php"style="background-color: pink;">
                                        <?php 
