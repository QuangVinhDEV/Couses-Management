                                ...
                                <div class="panel login-box" style="    background: white;">
                                    <div class="panel-heading">
                                       ...
                                       <div class="text-center"><br>
                                          <a href="#">
                    <img style="height: 200px;width:200px; margin-top: -50px; " src="assets/images/FPT-logo.png"></a>
                    <br>
                    <h3 style="margin-top: -50px; font-weight:bold">Admin Login</h3>
                                       </div>
                                    </div>
                                    <div class="panel-body p-20">
                                       <form class="admin-login" method="post">
                                          <div class="form-group">
                                             <label for="inputEmail3" class="control-label" style="color: black">Username</label>
                                             <input type="text" name="username" class="form-control" id="inputEmail3" placeholder="UserName">
                                          </div>
                                          <div class="form-group">
                                             <label for="inputPassword3" class="control-label" style="color: black">Password</label>
                                             <input type="password" name="password" class="form-control" id="inputPassword3" placeholder="Password">
                                          </div><br>
                                          <div class="form-group mt-20">
                                                <button type="submit" name="login" class="btn login-btn btn-primary">Sign in</button>
